...
saveRDS(n_vec,"/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/merge/res/n_vec.RDS")

# get overlap coefficient between pathway pairs
gse_lst = readRDS(paste0("/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/merge/",gse_ids[1],"_cp_gobp_pathcor.RDS"))
...
saveRDS(over_coef,"/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/merge/res/over_coef.RDS")
...
saveRDS(pathway_names,"/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/merge/res/pathway_names.RDS")
