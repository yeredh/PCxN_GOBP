...
close(pb)
saveRDS(p_mat,paste0("/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/GO/res/p_mat",args,".RDS"))
saveRDS(r_mat,paste0("/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/GO/res/r_mat",args,".RDS"))
