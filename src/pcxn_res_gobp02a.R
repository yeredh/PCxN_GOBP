...
# split GSE into four groups
gse_split = split(gse_ids, ceiling(seq_along(gse_ids)/421))
...
close(pb)
saveRDS(p_mat,paste0("/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/GOBP/res/p_mat",args,".RDS"))
saveRDS(r_mat,paste0("/net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/output/GOBP/res/r_mat",args,".RDS"))
